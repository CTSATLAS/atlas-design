...
<div class="container bordered bordered-no-north-south blue-background">
  <div class="powered-by">powered by ATLAS &amp; Bluedrop Learning Networks</div>
</div>
...
<div class="container bordered">
  <div class="row">
    <div class="col-md-6">
      <a href="#" class="media-link">
        <div class="media">
          ...
          <i class="fa fa-3x fa-angle-right visible-xs-inline-block" aria-hidden="true"></i>
        </div>
      </a>
    </div>
    ...
    <div class="col-md-6">
      <a href="#" class="media-link">
        <div class="media">
          <div class="media-left">
            <?= $this->Html->image('icons/upcoming-job-fairs-icon.png', array('alt' => 'Interactive Orientation Icon', 'class' => 'media-object')) ?>
          </div>
  ...
  <div class="row">
    <div class="col-md-6">
      <a href="https://www.caljobs.ca.gov/jobbanks/default.asp?p=0&session=jobsearch&geo=" class="media-link">
        <div class="media">
          <div class="media-left">
            <?= $this->Html->image('icons/search-job-boards-icon.png', array('alt' => 'Interactive Orientation Icon', 'class' => 'media-object')) ?>
          </div>
    ...
    <div class="col-md-6">
      <a href="#" class="media-link">
        <div class="media">
          <div class="media-left">
            <?= $this->Html->image('icons/learn-how-to-get-a-job-icon.png', array('alt' => 'Interactive Orientation Icon', 'class' => 'media-object')) ?>
          </div>
  ...
  <div class="row">
    <div class="col-md-6">
      <a href="#" class="media-link">
        <div class="media">
          <div class="media-left">
            <?= $this->Html->image('icons/skills-development-training-icon.png', array('alt' => 'Interactive Orientation Icon', 'class' => 'media-object')) ?>
          </div>
  ...
  <div class="row">
    <div class="col-md-6">
      <a href="http://www.pacific-gateway.org/featured-jobs" class="media-link">
        <div class="media">
          <div class="media-left">
            <?= $this->Html->image('icons/attend-a-workshop-icon.png', array('alt' => 'Interactive Orientation Icon', 'class' => 'media-object')) ?>
          </div>
    ...
    <div class="col-md-6">
      <a href="#" class="media-link">
        <div class="media">
          <div class="media-left">
            <?= $this->Html->image('icons/talk-to-our-experts-icon.png', array('alt' => 'Interactive Orientation Icon', 'class' => 'media-object')) ?>
          </div>
    ...
    <div class="col-md-6">
      <a href="#" class="media-link">
        <div class="media no-bottom-border">
          <div class="media-left">
            <?= $this->Html->image('icons/apply-for-programs-icon.png', array('alt' => 'Interactive Orientation Icon', 'class' => 'media-object')) ?>
          </div>
...
<div class="container watch-welcome-video">
<div class="row">
  <div class="col-md-12">
    <h5>
