<footer>
	...
	<div class="container">
		<div class="row">
			...
			<div class="span4">
				<h5>Workforce Plant City Career Center</h5>
			...
			<div class="span4">
				<h5>Workforce Brandon Career Center</h5>
	...
	<div class="container">
		<div class="row copyright">
			<div class="span12 centered">
				...
				<p class="eoe">
					ATLAS is an equal opportunity employer/program. Auxiliary aids and services are available upon request to individuals with disabilities. All voice telephone numbers listed on this website may be reached by persons using TTY/TDD equipment via the Florida Relay Service at 711.
				</p>
