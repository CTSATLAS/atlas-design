<footer>
	...
	<div class="maps-holder">
		<div class="container">
			<div class="row">
				<div class="span4">
					<h5>CareerSource Tampa Bay Center</h5>
				...
				<div class="span4">
					<h5>CareerSource Tampa Bay, Plant City Center</h5>
	...
	<div class="container">
		<div class="row">
			<div class="span6 offset3">
				<p>
					<a href="/">
						<img src="/img/theme/logo.png" alt="" style="width:150px;display:inline-block">
					</a>
					A proud partner <img src="/img/theme/ajobs.png" style="margin-top:-19px" /> of the Network.
				</p>
			</div>
		</div>
