...
<?php
	...
	echo '<input type="hidden" name="address_1" value="555 No Address" />';
	echo '<input type="hidden" name="city" value="No City" />';
	...
	echo '<input type="hidden" name="phone" value="0000000000" />';
	...
	echo $this->Form->input('disability', array(
		...
		'type' => 'select',
		'empty' => 'Please Select',
		'options' => array('0' => 'No Disability', '1' => 'Physical Disability', '2' => 'Mental Disability', '3' => "Intellectual Disablity"),
		'before' => '<br />',
		'after' => '<br />'
	));
