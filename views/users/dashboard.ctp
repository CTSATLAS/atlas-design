		...
		<div class="widget-content">
			<ul>
				...
				<li>
					...
					<span class="action">
						<a href="/events/cancel/<?= $value['Event']['id']?>" class="btn">Cancel Your Registration</a>
					</span>
				</li>
				<?php endforeach ?>
			</ul>
		...
		<div class="widget-content">
			...
			<?php foreach($ecourses as $key => $value) : ?>
				...
				<li>
					...
					<span class="action">
						<a href="/ecourses/index/<?= $value['Ecourse']['id'] ?>" class="btn">
		...
		<div class="widget-content">
			...
			<?php foreach($registrations as $key => $value) : ?>
				<li>
					...
					<span class="action">
						<a href="/programs/registration/<?= $value['Program']['id'] ?>" class="btn">
							<?= (!empty($value['ProgramResponse']) ? Inflector::humanize($value['ProgramResponse'][0]['status']) : 'Get Started') ?>
						</a>
					</span>
				</li>
		...
		<div class="widget-content">
			...
			<?php foreach($orientations as $key => $value) : ?>
				<li>
					...
					<span class="action">
						<a href="/programs/orientation/<?= $value['Program']['id'] ?>" class="btn">
							<?= (!empty($value['ProgramResponse']) ? Inflector::humanize($value['ProgramResponse'][0]['status']) : 'Get Started') ?>
						</a>
					</span>
				</li>
		...
		<div class="widget-content">
			...
			<?php foreach($enrollments as $key => $value) : ?>
				<li>
					...
					<span class="action">
						<a href="/programs/enrollment/<?= $value['Program']['id'] ?>" class="btn">
							<?= (!empty($value['ProgramResponse']) ? Inflector::humanize($value['ProgramResponse'][0]['status']) : 'Get Started') ?>
						</a>
					</span>
				</li>
