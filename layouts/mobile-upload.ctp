...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <link rel="stylesheet" href="/css/theme/bootstrap-latest/bootstrap.css">
        <link rel="stylesheet" href="/css/theme/bootstrap-latest/main.css">
 ...
 <section id="content">
     ...
     <!-- /container -->        <script src="//ajax.googleapis.com/ajax/libs/jquery/1.10.1/jquery.min.js"></script>
        ...
        <script src="js/vendor/knockout-latest.js"></script>
