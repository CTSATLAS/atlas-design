...
<head>
	...
	<link rel="stylesheet" href="/css/core/atlas-icons/style.css" type="text/css">
        <?php echo $this->Html->css('core/sg-grid'); ?>

<link rel="stylesheet" href="/css/core/core-style.css" type="text/css" media="screen">
...
<?php echo $this->element('core-panwar/header') ?>
