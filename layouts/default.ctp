...
<html lang="en">
    <head>
        ...
        <script>
            ...
            fbq('init', '1644295922307239'); 
            fbq('track', 'PageView');
        </script>

        <noscript>
            <img height="1" width="1" src="https://www.facebook.com/tr?id=1644295922307239&ev=PageView&noscript=1"/>
        </noscript>
    ...
    <meta name="theme-color" content="#ffffff">
        ...
        <!-- title -->
        <title>
            <?= $title_for_layout ?> &mdash; <?php __('CareerSource CLM') ?></title>
    </head>
<body>
