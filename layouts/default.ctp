...
<body>
    ...
    <script type="text/javascript">
        ...
        (function() {
            ...
            po.src = '//atlas.shawn/webroot/livechat/index.php/chat/getstatus/(click)/internal/(position)/bottom_right/(ma)/br/(top)/350/(units)/pixels/(leaveamessage)/true?r='+referrer+'&l='+location;
