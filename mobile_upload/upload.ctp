...
<?php if($success) : ?>
<h3 class="text-success" style="font-size: 21px;">Thank you we have received your document. If you have other documents to submit, please repeat the steps below.</h3>
<?php endif ?>
